...
struct StoryBrain {
    ...
    func getStoryTitle() -> String {
        return destini[storyNumber].title   //Text of the Story
    }
    
    mutating func nextStory(_ userChoice: String) -> String {
        if userChoice == destini[storyNumber].choice1  {
            var choice1DestinationNumber = destini[storyNumber].choice1Destination
            storyNumber = choice1DestinationNumber
            return destini[storyNumber].title
        } else {
            var choice2DestinationNumber = destini[storyNumber].choice2Destination
            storyNumber = choice2DestinationNumber
            return destini[storyNumber].title
        }
    }
